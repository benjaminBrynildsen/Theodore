...
export function extractCanonFromConversation(_messages: string[]): AutoGeneratedCanon {
  // In production: AI analyzes the conversation and extracts all mentioned entities
  // For now: returns example data that matches common story patterns
  return {
    characters: [
      { name: 'Protagonist', description: 'The main character of the story', role: 'protagonist' },
    ],
    locations: [
      { name: 'Primary Setting', description: 'The main location where the story takes place', role: 'protagonist' } as any,
    ],
    systems: [],
    artifacts: [],
  };
