      ...
      <div className="p-2 border-t border-white/10">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 bg-transparent outline-none text-base sm:text-[13px] text-text-primary placeholder:text-text-tertiary resize-none glass-input rounded-lg px-3 py-2"
          />
          <button
            onClick={handleSend}
