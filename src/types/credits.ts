...
export const FREE_TIER_CREDITS = 400;
...
export const PLAN_DETAILS: Record<PlanTier, {
  ...
  free: {
    ...
    features: [`${FREE_TIER_CREDITS} credits/month`, '~3 AI chapters', '60s audio preview', '1 active project'],
  },
  writer: {
    name: 'Writer',
    ...
    features: ['2,500 credits/month', '~83 AI chapters', '~30 audio chapters', 'Unlimited projects'],
  },
  author: {
    name: 'Author',
    ...
    features: ['7,500 credits/month', '~250 AI chapters', '~100 audio chapters', 'Unlimited projects', 'Premium models'],
  },
  studio: {
    name: 'Studio',
    ...
    features: ['25,000 credits/month', '~833 AI chapters', '~330 audio chapters', 'Unlimited projects', 'Priority support'],
  },
  publisher: {
    name: 'Publisher',
    ...
    features: ['50,000 credits/month', '~1,666 AI chapters', '~660 audio chapters', 'Unlimited projects', 'Premium models', 'Priority support', 'Dedicated onboarding'],
  },
};
